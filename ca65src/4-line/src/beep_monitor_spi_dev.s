...
;; =========|========|========|=======|======|======|======|===========
;;   beep   |        | clock  |       |      | spi  |      | mem block
;;   active |        | active |       |      |      |      | update view
...
spi_porta_2:
  ...
  lda TICKS
  sbc SPI_LAST
  cmp #10 ; send SPI data 10 times per second - PyBoard toggles LED on/off at 5Hz
  bcc exit_spi_porta_2
  jsr send_spi
@exit:
  lda TICKS
  sta SPI_LAST
